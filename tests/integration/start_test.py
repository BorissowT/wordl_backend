...
def test_if_game_id_is_the_same_when_new_player_joins_with_invitation_link(client):
    """
    ...
    invited_user_data = {"username": "tim_user", "skin": 8}
    response_of_new_player = client.post(f"/api/start/{game_id_start_player}", json=invited_user_data)
